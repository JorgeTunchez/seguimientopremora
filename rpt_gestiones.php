    ...
    ?>
      <div id="no-more-tables">
        ...
        <table class="table table-sm table-hover">
          <tr>
            <td colspan="4" style="background-color: #20b4c5; color:white; text-align:center;">
              <h1>Estadisticas por Estado Actual del Préstamo</h1>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="text-align:center;">
              <h4><?php print $arrEstadoActual["ALDIA"]; ?></h4>
            </td>
          </tr>
          <tr>
            <td style="text-align:center;">
            ...
            <td style="text-align:center;">
              <h4><?php print $arrEstadoActual["CANCELADO"]; ?></h4>
            </td>
          </tr>
          <tr>
            <td style="text-align:center;">
            ...
            <td style="text-align:center;">
              <h4><?php print $arrEstadoActual["ENMORA"]; ?></h4>
            </td>
          </tr>
          <tr>
            <td style="text-align:center;">
            ...
            <td style="text-align:center;">
              <h4><?php print $arrEstadoActual["PREMORA"]; ?></h4>
            </td>
          </tr>
          <tr>
        ...
        ?>
          <table class="table table-sm table-hover">
            <tr>
              <td colspan="3" style="background-color: #20b4c5; color:white; text-align:center;">
            ...
            ?>
              <tr>
                <td colspan="3" style="background-color: #0fcfe5; color:white; text-align:center;">
                  <h2><?php print $strCategoria; ?></h2>
                </td>
              </tr>
              <tr>
                <td style="text-align:center;">
                  <h4><b>Subcategoria</b></h4>
                </td>
                <td style="text-align:center;">
                  <h4><b>Porcentaje</b></h4>
                </td>
              ...
              ?>
                <tr>
                  <td style="text-align:center;">
                    <h4><?php print $strSubCategoria; ?></h4>
                  </td>
                  <td style="text-align:center;"><?php print $intPorcentaje . '%'; ?></td>
                  <td style="text-align:center;">
                    <h4><?php print $intRecuento; ?></h4>
                  </td>
                </tr>
            <?php
              }
            ...
            <tr>
              ...
              <td style="text-align:center;">
                <h4><b><?php print $intTotalRecuento; ?></b></h4>
              </td>
            </tr>
          </table>
        <?php
