...
class lrb_controller
{
  ...
  public function ajaxsaveEditDatosAsoc()
  {
    if (isset($_POST["saveEditDatosAsoc"]) && $_POST["saveEditDatosAsoc"] == "true") {
      ...
      $this->objModel->ajaxsaveEditDatosAsoc(
        $streditCIF,
        $streditAsocCelular,
        $streditAsocTelCasa,
        $streditAsocTelOfi,
  ...
  public function drawBlurDetailContent($arrDetail)
  {
    ...
    ?>
      <table class="table table-borderless table-sm">
        ...
        <!-- datos del prestamo-->
        <tr>
          <td colspan="4" style="background-color: #00a65a; color:white;">
        ...
        <tr>
          <td colspan="3" style="background-color: #00a65a; color:white;">
