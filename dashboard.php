                ...
                <div class="col-lg-4 col-xs-12">
                  ...
                  <div class="small-box bg-aqua">
                    <div class="inner" style="color:white;">
                      ...
                      <p><h4>Préstamos desde premora</h4></p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                    </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="small-box bg-aqua">
                  <div class="inner" style="color:white;">
                    ...
                    <p><h4>Cantidad préstamos premora</h4></p>
                  </div>
                  <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="small-box bg-aqua">
                  <div class="inner" style="color:white;">
                    ...
                    <p><h4>Cantidad de préstamos con gestión</h4></p>
                  </div>
                  <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="small-box bg-aqua">
                  <div class="inner" style="color:white;">
                    ...
                    <p><h4>Cantidad de préstamos sin gestión</h4></p>
                  </div>
                  <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="small-box bg-aqua">
                  <div class="inner" style="color:white;">
                    ...
                    <p><h4>Cantidad de préstamos Cuota Cero</h4></p>
                  </div>
                  <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                  </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-body">
                      ...
                      <div style="text-align:center;"><h4> Promedio: <?php print 'Q.'.number_format($decPromedioSaldo, 2, '.', ','); ?></h4></div>
                    </div>
                    <!-- /.box-body-->
                  </div>
                  <!-- /.box -->
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                      ...
                      <div style="text-align:center;"><h4> Promedio: <?php print $decPromedioConteo; ?></h4></div>
                    </div>
                </div>
              </div>
            </div>
