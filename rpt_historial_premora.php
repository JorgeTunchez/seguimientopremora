...
class rpt_hp_view{
  ...
  public function drawContentDetail($arrDetail, $boolExport = false ){
    if( count($arrDetail)>0 ){
      ...
      <table class="table">
        <tr>
          <td  colspan="2" style="background-color: #20b4c5; color:white; text-align:center;"><h3>Resumen Historial Premora</h3></td>
        </tr>
        <tr>
            ...
            <div class="box box-info content">
              <div class="box-header content">
                ...
                <div id="divFiltros">
                  ...
                  <br>
                  <div class="row">
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="text-align:center; vertical-align:middle;"><h4><b>Mes</b></h4></div>
                  ...
                  <br>
                  <div class="row">
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="text-align:center; vertical-align:middle;"><h4><b>Año</b></h4></div>
                    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9" style="text-align:center; vertical-align:middle;">
